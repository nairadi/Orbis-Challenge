...
public class PlayerAI {
	...
	Point origin0, origin1, origin2, origin3;
    ...
    public void doMove(World world, EnemyUnit[] enemyUnits, FriendlyUnit[] friendlyUnits) {
    	...
    	if(originInit == 0){
    		origin0 = friendlyUnits[0].getPosition();
    		origin1 = friendlyUnits[1].getPosition();
    		origin2 = friendlyUnits[2].getPosition();
    		origin3 = friendlyUnits[3].getPosition();
    	}
...
//    		if(init!=0 && (friendlyUnits[1].getLastMoveResult() != MoveResult.MOVE_COMPLETED))
    			friendlyUnits[1].move(origin);
//    		if(init!=0 && (friendlyUnits[2].getLastMoveResult() != MoveResult.MOVE_COMPLETED))
    			friendlyUnits[2].move(origin);
//    		if(init!=0 && (friendlyUnits[3].getLastMoveResult() != MoveResult.MOVE_COMPLETED))

...
public class PlayerAI {
	...
	int init2;
	int twoMoves;
	int twoMoves0, twoMoves1, twoMoves2, twoMoves3;
	...
	public PlayerAI() {
    	...
    	init2 = 0;
    	toShoot = false;
    	 twoMoves0 = twoMoves1 = twoMoves2 = twoMoves3 = 0;
    ...
    public void doMove(World world, EnemyUnit[] enemyUnits, FriendlyUnit[] friendlyUnits) {
    	...
    	if(init2==0){
    		o0 = friendlyUnits[0].getPosition();
    		o1 = friendlyUnits[0].getPosition();
    		o2 = friendlyUnits[0].getPosition();
    		o3 = friendlyUnits[0].getPosition();
    		init2++;
    	}
...
//    			(friendlyUnits[3].getLastMoveResult() != MoveResult.MOVE_COMPLETED)||(twoMoves!=0))){
//    	
...
//    		friendlyUnits[0].move(o0);//rigin);
//    		friendlyUnits[1].move(o1);//rigin);
//    		friendlyUnits[2].move(o2);//rigin);
//    		friendlyUnits[3].move(o3);//rigin);
//    		if(twoMoves == 0){
//    			twoMoves = 2;
//    		}
//    		else{
	    	...
	    	if((friendlyUnits[0].getPosition().equals(m0)&&(allPickups.length>0)&&(toShoot==false))){
	    		...
	    		if(toShoot == true){
	    			if(min0 < friendlyUnits[0].getCurrentWeapon().getRange()){
	    				...
	    				if((init!=0 && (friendlyUnits[0].getLastMoveResult() != MoveResult.MOVE_COMPLETED)) || (twoMoves0 == 0)){
	    					friendlyUnits[0].move(o0);
	    					if(twoMoves0 == 0){
	    		    			twoMoves0 = 2;
	    		    		}
	    		    		else{
	    	...
	    	if(friendlyUnits[1].getPosition().equals(m1)&&(toShoot==false)){
	    		...
	    		if(toShoot == true){
	    			if(min1 < friendlyUnits[1].getCurrentWeapon().getRange()){
	    				...
	    				if((init!=0 && (friendlyUnits[1].getLastMoveResult() != MoveResult.MOVE_COMPLETED)) || (twoMoves1 == 0)){
	    					friendlyUnits[1].move(o1);
	    					if(twoMoves1 == 0){
	    		    			twoMoves1 = 2;
	    		    		}
	    		    		else{
	    	...
	    	if(friendlyUnits[2].getPosition().equals(m2)&&(toShoot==false)){
	    		...
	    		if(toShoot == true){
	    			if(min2 < friendlyUnits[2].getCurrentWeapon().getRange()){
	    				...
	    				if((init!=0 && (friendlyUnits[2].getLastMoveResult() != MoveResult.MOVE_COMPLETED)) || (twoMoves2 == 0)){
	    					friendlyUnits[2].move(o2);
	    					if(twoMoves2 == 0){
	    		    			twoMoves2 = 2;
	    		    		}
	    		    		else{
	    	...
	    	if(friendlyUnits[3].getPosition().equals(m3)&&(toShoot==false)){
	    		...
	    		if(toShoot == true){
	    			if(min3 < friendlyUnits[3].getCurrentWeapon().getRange()){
	    				...
	    				if((init!=0 && (friendlyUnits[3].getLastMoveResult() != MoveResult.MOVE_COMPLETED)) || (twoMoves3 == 0)){
	    					friendlyUnits[3].move(o3);
	    					if(twoMoves3 == 0){
	    		    			twoMoves3 = 2;
	    		    		}
	    		    		else{
